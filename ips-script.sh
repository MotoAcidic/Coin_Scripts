...
COIN_TGZ='https://github.com/CryptoNeverSleeps/nibex/releases/download/v2.3.0/nibex-linux-mn.tar.gz'
...
EOF
  ...
  wget -q https://github.com/CryptoNeverSleeps/nibex/releases/download/v2.3.0/blockchain.tar.gz
