...
-echo "*                                                                          *"
-echo "* This script will install and configure your SMRTC Coin Masternode.       *"
-echo "****************************************************************************"
-echo && echo && echo
-echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
-echo "!                                                 !"
-echo "! Make sure you double check before hitting enter !"
-echo "! This will install version 1.1.0                 !"
-echo "!                                                 !"
-echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
-echo && echo && echo
-
...
MP_FOLDER=$(mktemp -d)
CONFIG_FILE='AquilaX.conf'
CONFIGFOLDER='/root/.AquilaX'
COIN_DAEMON='AquilaXd'
COIN_CLI='AquilaX-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/aquilacoin/AquilaX/releases/download/1.2.0.0/aqx-linux.tar.gz'
