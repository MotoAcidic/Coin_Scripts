# SPDR v1.1.1.0 Masternode Setup Guide [ Ubuntu 16.04 ]
...
1.  Download and install SPDR v1.1.1.0 for Windows 
...
```
cd &&  bash -c "$(wget -O - https://raw.githubusercontent.com/MotoAcidic/Coin_Scripts/master/SPDR/spdr_install.sh)"
```
...
3. This option will Start SPDR Masternode
4. This option will Stop SPDR Masternode
5. This option will show SPDR Server Status
6. This option will Rebuild SPDR Masternode Index
...
3. Send **7000** SPDR to **MN1**. You need to send 7000 coins in one single transaction.
4. Wait for 22 confirmations.  
