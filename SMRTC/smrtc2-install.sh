...
addnode=107.172.249.143:9887
addnode=23.94.183.5:9887
addnode=172.245.6.154:9887
EOF
clear
./smrtcd -daemon
./smrtc-cli stop
...
echo cryptocashback Server Started Successfully using the command ./smrtcd -daemon
...
echo Please use the following Private Key when setting up your wallet: $GENKEY
        ...
        2)
sudo ./smrtc-cli -daemon stop
echo "! Stopping smrtc Daemon !"
