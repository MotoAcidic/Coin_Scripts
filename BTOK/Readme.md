# BTOK v1.0.0.3 Masternode Setup Guide [ Ubuntu 16.04 ]
...
1.  Download and install BTOK v1.0.0.3 for Windows 
...
3. This option will Start BTOK Masternode
4. This option will Stop BTOK Masternode
5. This option will show BTOK Server Status
6. This option will Rebuild BTOK Masternode Index


If you need to go back and either start or stop Beetok just use this command.
```
cd &&  bash -c "$(wget -O - https://raw.githubusercontent.com/MotoAcidic/Coin_Scripts/master/BTOK/btok_install.sh)"
```
...
3. Send **2000** SPDR to **MN1**. You need to send 2000 coins in one single transaction.
4. Wait for 60 confirmations.  
