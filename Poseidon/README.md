# Poseidon v1.2.0.2 Masternode Setup Guide [ Ubuntu 16.04 ]
...
1.  Download and install Poseidon v1.2.0.1 for Windows 
...
```
cd &&  bash -c "$(wget -O - https://raw.githubusercontent.com/MotoAcidic/Coin_Scripts/master/Poseidon/posq-install.sh)"
```
...
3. This option will Start Poseidon Masternode
4. This option will Stop Poseidon Masternode
5. This option will show Poseidon Server Status
6. This option will Rebuild Poseidon Masternode Index
...
3. Send **50000** POSQ to **MN1**. You need to send 50000 coins in one single transaction.
